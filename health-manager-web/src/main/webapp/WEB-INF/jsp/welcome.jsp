                ...
                <div class="col-lg-7">
                    ...
                    <div class="custom-bar-chart">
                        ...
                        <div class="bar">
                            ...
                            <div id="jan" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">FEB</div>
                            <div id="feb" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">90%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">MAR</div>
                            <div id="mar" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">APR</div>
                            <div id="apr" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar">
                            <div class="title">MAY</div>
                            <div id="may" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">JUN</div>
                            <div id="jun" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar">
                            <div class="title">JUL</div>
                            <div id="jul" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">AUG</div>
                            <div id="aug" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">SEP</div>
                            <div id="sep" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">OCT</div>
                            <div id="oct" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">NOV</div>
                            <div id="nov" class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                        <div class="bar ">
                            <div class="title">DEC</div>
                            <div id="dec"class="value1 tooltips" data-original-title="0%" data-toggle="tooltip" data-placement="top">0%</div>
                        </div>
                    </div>
                    <!--custom chart end-->
                </div>
                            ...
                            <div class="tab-content tasi-tab">
                                <div class="tab-pane active" id="popular">
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p><br>健康校园是基于SOA架构的大型开源分布式校园健康管理平台，前后端开发分离，前台
                                                基于MVP开发的Android端，前台App下载演示地址：<a href="" target="_blank">点我查看</a><br><br>
                                                后台几乎完成所有功能开发，你所看到的几乎皆为真实后台数据，为避免数据遭恶意修改，测试体验账号只具备查看权限。
                                                后台主要使用技术有Dubbo/SSM/SolrCloud/Redis/MySQL/ActiveMQ/FastDFS/Zookeeper等<br><br>
                                                Github后台源码:<a href="https://github.com/Zhangguangte/HealthyCampus_Server" target="_blank">
                                                    <img src="https://img.shields.io/github/stars/Zhangguangte/HealthyCampus_Server.svg?style=social&label=Stars">
                                                    <img src="https://img.shields.io/github/forks/Zhangguangte/HealthyCampus_Server.svg?style=social&label=Fork"></a>
                                                前台：<a href="https://github.com/Zhangguangte/HealthyCampus" target="_blank">
                                                    <img src="https://img.shields.io/github/stars/Zhangguangte/HealthyCampus.svg?style=social"></a><br>
                                ...
                                <div class="tab-pane " id="recent">
                                    ...
                                    <div style="text-align: center;margin-top:10px;">
                                        <img width="180px" height="180px" src="icon/income1.png" style="margin-right:10px;">
                                        <img width="180px" height="180px" src="icon/income2.png" style="margin-left:10px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-hover personal-task">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="mailto:741737219@qq.com" target="_blank">741737219@qq.com</a>
                                </td>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <span class="timeline-date">14:00 pm</span>
                                                <h1 class="purple">10 Feb | Monday</h1>
                                                <p>
                                                    感谢 <a href="https://github.com/Exrick/xmall" target="_blank">Exrick</a> 的开源
                                                    <a href="https://github.com/Exrick/xmall" target="_blank">XMall</a> 项目提供后台页面及框架支持
                                                </p>
                                                <div class="notification">
                                                    <i class=" icon-exclamation-sign"></i> 启动了后台项目
                                                    <a href="#">Health-Manager</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">小友</a> 开始编写
                                                    <span><a href="#" class="light-green">校园健康App</a></span>
                                          </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <footer class="social-footer">
                                        <ul>
                                            ...
                                            <li class="active">
                                                <a href="#">
                                                    <img style="margin-bottom: 3px" width="40px" height="40px" src="icon/qq.png"></img>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
    		...
    		$.ajax({
		        ...
		        success:function (data) {
		            if(data.success==true){
		            	...
		            	$("#jan").html(data.data[0]/data.recordsTotal*100+"%");
		            	$("#jan").attr("data-original-title",data.data[0]/data.recordsTotal*100+"%");
		            	$("#jan").attr('style','height:'+data.data[0]/data.recordsTotal*100+"%;");
		            	
		            	$("#feb").html(data.data[1]/data.recordsTotal*100+"%");
		            	$("#feb").attr("data-original-title",data.data[1]/data.recordsTotal*100+"%");
		            	$("#feb").attr('style','height:'+data.data[1]/data.recordsTotal*100+"%;");
		            	
		            	$("#mar").html(data.data[2]/data.recordsTotal*100+"%");
		            	$("#mar").attr("data-original-title",data.data[2]/data.recordsTotal*100+"%");
		            	$("#mar").attr('style','height:'+data.data[2]/data.recordsTotal*100+"%;");
		            	
		            	$("#apr").html(data.data[3]/data.recordsTotal*100+"%");
		            	$("#apr").attr("data-original-title",data.data[3]/data.recordsTotal*100+"%");
		            	$("#apr").attr('style','height:'+data.data[3]/data.recordsTotal*100+"%;");
		            	
		            	$("#may").html(data.data[4]/data.recordsTotal*100+"%");
		            	$("#may").attr("data-original-title",data.data[4]/data.recordsTotal*100+"%");
		            	$("#may").attr('style','height:'+data.data[4]/data.recordsTotal*100+"%;");
		            	
		            	$("#jun").html(data.data[5]/data.recordsTotal*100+"%");
		            	$("#jun").attr("data-original-title",data.data[5]/data.recordsTotal*100+"%");
		            	$("#jun").attr('style','height:'+data.data[5]/data.recordsTotal*100+"%;");
		            	
		            	$("#jul").html(data.data[6]/data.recordsTotal*100+"%");
		            	$("#jul").attr("data-original-title",data.data[6]/data.recordsTotal*100+"%");
		            	$("#jul").attr('style','height:'+data.data[6]/data.recordsTotal*100+"%;");
		            	
		            	$("#aug").html(data.data[7]/data.recordsTotal*100+"%");
		            	$("#aug").attr("data-original-title",data.data[7]/data.recordsTotal*100+"%");
		            	$("#aug").attr('style','height:'+data.data[7]/data.recordsTotal*100+"%;");
		            	
		            	$("#sep").html(data.data[8]/data.recordsTotal*100+"%");
		            	$("#sep").attr("data-original-title",data.data[8]/data.recordsTotal*100+"%");
		            	$("#sep").attr('style','height:'+data.data[8]/data.recordsTotal*100+"%;");
		            	
		            	$("#oct").html(data.data[9]/data.recordsTotal*100+"%");
		            	$("#oct").attr("data-original-title",data.data[9]/data.recordsTotal*100+"%");
		            	$("#oct").attr('style','height:'+data.data[9]/data.recordsTotal*100+"%;");
		            	
		            	$("#nov").html(data.data[10]/data.recordsTotal*100+"%");
		            	$("#nov").attr("data-original-title",data.data[10]/data.recordsTotal*100+"%");
		            	$("#nov").attr('style','height:'+data.data[10]/data.recordsTotal*100+"%;");
		            	
		            	$("#dec").html(data.data[11]/data.recordsTotal*100+"%");
		            	$("#dec").attr("data-original-title",data.data[11]/data.recordsTotal*100+"%");
		            	$("#dec").attr('style','height:'+data.data[11]/data.recordsTotal*100+"%;");
   ...
   /*  setTimeout('count()',2000);
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            $("#airCondition").html("PM:"+data.result.pm + "  "+data.result.pm_level);
            $("#wind").html(data.result.wd+"  "+data.result.ws+"  ");
            $("#updateTime").html(data.result.week+"  "+data.result.updateTime);
