...
<div class="page-container">
    <form name="library-add" action="" method="post" class="form form-horizontal" id="library-add">
        <div class="row cl">
            <h3 class="form-label col-xs-4 col-sm-2"  style="color: tomato;text-decoration:underline;">图书信息:</h3>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图书名称:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入图书名称" id="name" name="name"/>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入价格" id="price" name="price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>出版社:</label>
            <div class="formControls col-xs-8 col-sm-9">
               	<input type="text" class="input-text" value="" placeholder="请输入出版社" id="publish" name="publish">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>总量:</label>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="" placeholder="请输入总量" id="sum" name="sum">
            </div>
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>剩余量</label>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" class="input-text" value="" placeholder="请输入剩余量" id="rest" name="rest">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
				...
				<input type="text" onclick="chooseCategory('选择分类',4,3,0)" readonly class="input-text" value="" placeholder="请选择分类" id="cname0" name="cname[0]" style="width:45%">
            ...
            <div class="formControls col-xs-3 col-sm-3">
				...
				<input type="text" onclick="chooseCategory('选择分类',4,3,1)" readonly class="input-text" value="" placeholder="请选择分类" id="cname1" name="cname[1]" style="width:45%">
                <input type="button" onclick="chooseCategory('选择分类',4,3,1)" class="btn btn-secondary radius" value="选择分类">
            </div>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" hidden class="input-text" id="cid2" name="cid[2]" >
				<input type="text" onclick="chooseCategory('选择分类',4,3,2)" readonly class="input-text" value="" placeholder="请选择分类" id="cname2" name="cname[2]" style="width:45%">
                <input type="button" onclick="chooseCategory('选择分类',4,3,2)" class="btn btn-secondary radius" value="选择分类">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
				  <select class="select" size="1" name="place" id="place">
				    <option value="文史类书库(103)">文史类书库(103)</option>
				    <option value="社科书库(202)">社科书库(202)</option>
				    <option value="语言类书库(201)">语言类书库(201)</option>
				    <option value="语言类书库(101)">语言类书库(101)</option>
				    <option value="文史哲书库(301)">文史哲书库(301)</option>
				    <option value="理工类书库(302)">理工类书库(302)</option>
				    <option value="法学书库(203)">法学书库(203)</option>
				    <option value="医学类书库(102)">医学类书库(102)</option>
				  </select>
				</span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>索引号:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入总量" id="bIndex" name="bIndex">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>简介:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea class="input-text" value="" placeholder="请输入简介" id="introduced" name="introduced" style="min-height:80px;resize:none;"></textarea>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
	...
	$("#library-add").validate({
	    ...
	    submitHandler:function(form){
	    	...
	    	var rest = parseFloat($("#rest").val());
	    	
	        if(sum < rest){
	        	layer.alert("剩余量不可以大于总量", {title: '错误信息',icon: 2});
	        	return;
	        }
    ...
    var index = layer.load(3);
       ...
       success: function(data){
           ...
           $("#introduced").val(data.result.introduced);
           $("#sum").val(data.result.sum);
           $("#rest").val(data.result.rest);
           
           $("#bIndex").val(data.result.bIndex);

           $("#place option[value='"+data.result.place+"']").prop('selected', true);
