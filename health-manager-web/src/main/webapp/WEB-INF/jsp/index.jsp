...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">校园健康后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">校园健康后台管理系统</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li id="Hui-msg"> <a title="消息"><!-- <span class="badge badge-danger">3</span> --><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="refresh-system-redis" data-title="系统缓存管理" href="javascript:void(0)">系统缓存管理</a></li>
                    <li><a data-href="refresh-dis-med-rec-redis" data-title="疾、药、食板块缓存管理" href="javascript:void(0)">疾、药、食板块缓存管理</a></li>
