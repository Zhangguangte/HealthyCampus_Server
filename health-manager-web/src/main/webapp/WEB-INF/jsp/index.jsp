...
<body>
	<header class="navbar-wrapper">
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">校园健康后台管理系统</a>
				<a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">校园健康后台管理系统</a>
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							class="dropDown_A"><sapn id="username"></sapn> <i
								class="Hui-iconfont">&#xe6d5;</i></a>
							<ul class="dropDown-menu menu radius box-shadow">
						...
						<li id="LockScreen"><a href="lock-screen" title="锁屏"><i
								class="Hui-iconfont" style="font-size: 18px">&#xe60e;</i></a></li>
						<li id="Hui-msg"><a title="消息">
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			...
			<dl id="menu-picture">
				<dt>
					<i class="Hui-iconfont">&#xe634;</i> 缓存管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
			...
			<dl id="recipes-medicine">
				...
				<dd>
					<ul>
						<li><a data-href="item-categorys?type=2" data-title="食谱分类" href="javascript:void(0)">食谱分类</a></li>
						<li><a data-href="recipes-list" data-title="食谱列表" href="javascript:void(0)">食谱列表</a></li>
						<li><a data-href="recipes-canteen" data-title="食堂" href="javascript:void(0)">食堂</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-order">
			...
			<dl id="menu-search">
				<dt>
					<i class="Hui-iconfont">&#xe665;</i> 搜索管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="refresh-index" data-title="同步索引"
							href="javascript:void(0)">同步索引</a></li>
						<li><a data-href="dict-list" data-title="词典库管理"
							href="javascript:void(0)">词典库管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-comments">
			...
			<dl id="menu-system">
				...
				<dd>
					<ul>
						<li><a data-href="system-base" data-title="基本设置"
							href="javascript:void(0)">基本设置</a></li>
						<li><a data-href="system-shiro" data-title="权限配置"
							href="javascript:void(0)">权限配置</a></li>
						<li><a data-href="system-log" data-title="系统日志"
		...
		<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
			<div class="Hui-tabNav-wp">
				<ul id="min_title_list" class="acrossTab cl">
					<li class="active"><span title="我的首页" data-href="welcome">我的首页</span>
						<em></em></li>
				</ul>
			</div>
