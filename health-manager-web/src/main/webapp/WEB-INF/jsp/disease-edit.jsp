        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-2 col-sm-2">
              	<a id="imageUrl" target="_blank">
              		<image class="thumbnail" id="imageShow" style="height:100px;width:100px;" alt="lose image"/>
            	</a>
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
	...
	$("#disease-add").validate({
	    ...
	    submitHandler:function(form){
	        ...
	        $(form).ajaxSubmit({
	            url: "/item/disease/update/"+parent.getId(),
	            type: "POST",
	            dataType: "json",
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $("#contagious").val(data.result.contagious);
            $("#insurance").val(data.result.insurance);
            $("#dcheck").val(data.result.dcheck);
            $("#depart").val(data.result.depart);
            $("#part").val(data.result.part);
            $("#population").val(data.result.population);
            
            $("#part0").val(data.result.part[0]);
            $("#pid0").val(data.result.pid[0]);
            if(data.result.part.length > 1){
            	$("#part1").val(data.result.part[1]);
            	$("#pid1").val(data.result.pid[1]);
            	if(data.result.part.length > 2){            		
            		$("#part2").val(data.result.part[2]);
                 	$("#pid2").val(data.result.pid[2]);
                 }
            }
            
            $("#depart0").val(data.result.depart[0]);
            $("#did0").val(data.result.did[0]);
            if(data.result.depart.length > 1){
            	$("#depart1").val(data.result.depart[1]);
            	$("#did1").val(data.result.did[1]);
            	if(data.result.depart.length > 2){
            		$("#depart2").val(data.result.depart[2]);
            	 	$("#did2").val(data.result.did[2]);
            	 }
            }
        	...
        	/*  疾病知识	 */
            $("#complication").val(data.result.complication);
            $("#symptoms").val(data.result.symptoms);
            $("#dcase").val(data.result.dcase);
            $("#prevention").val(data.result.prevention);
            
            /*   治疗知识	 */
            $("#rate").val(data.result.rate);
            $("#way").val(data.result.way);
            $("#cost").val(data.result.cost);
            $("#drug").val(data.result.drug);
