...
<div class="page-container">
    <form name="recipes-add" action="" method="post" class="form form-horizontal" id="recipes-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>食谱名称:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入食谱名称" id="name" name="name"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>功效:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入功效" id="functional" name="functional">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>口味:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入口味" id="flavor" name="flavor">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>食材:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea class="input-text" value="" placeholder="例:(xx:1份,xxx:500g)" id="ingredients" name="ingredients" style="min-height:80px;resize:none;"></textarea>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>烹饪:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入烹饪方法:例:(烤)" id="process" name="process">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>时长:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入时长:例:(&lt;15分钟)" id="time" name="time">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>步骤:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea class="input-text" value="" placeholder="例:(1.xxxxx,2.xxxxxxxx,3.xxxxx)" id="practice" name="practice" style="min-height:80px;resize:none;"></textarea>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>卡路里(100克/千卡):</label>
            <div class="formControls col-xs-8 col-sm-9">
            	<input type="text" class="input-text" id="calorie" name="calorie" placeholder="请输入卡路里">
            </div>
        </div>
        <div class="row cl">
        	<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>成分(100克):</label>
            <label class="form-label col-xs-1 col-sm-1">碳水化合:</label>
            <div class="formControls col-xs-2 col-sm-2">
            	<input type="text" class="input-text" id="components0" name="components[0]" placeholder="碳水化合" style="width:50%">克
            </div>
            <label class="form-label col-xs-1 col-sm-1">脂肪:</label>
            <div class="formControls col-xs-2 col-sm-2">
            	<input type="text" class="input-text" id="components1" name="components[1]" placeholder="脂肪" style="width:50%">克
            </div>
            <label class="form-label col-xs-1 col-sm-1">蛋白质:</label>
            <div class="formControls col-xs-2 col-sm-2">
            	<input type="text" class="input-text" id="components2" name="components[2]" placeholder="蛋白质" style="width:50%">克
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-3">
				...
				<input type="text" onclick="chooseCategory('选择分类',2,3,0)" readonly class="input-text" value="" placeholder="请选择分类" id="cname0" name="cname[0]" style="width:45%">
                <input type="button" onclick="chooseCategory('选择分类',2,3,0)" class="btn btn-secondary radius" value="选择分类">
            </div>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" hidden class="input-text" id="cid1" name="cid[1]" >
				<input type="text" onclick="chooseCategory('选择分类',2,3,1)" readonly class="input-text" value="" placeholder="请选择分类" id="cname1" name="cname[1]" style="width:45%">
                <input type="button" onclick="chooseCategory('选择分类',2,3,1)" class="btn btn-secondary radius" value="选择分类">
            </div>
            <div class="formControls col-xs-3 col-sm-3">
                <input type="text" hidden class="input-text" id="cid2" name="cid[2]" >
				<input type="text" onclick="chooseCategory('选择分类',2,3,2)" readonly class="input-text" value="" placeholder="请选择分类" id="cname2" name="cname[2]" style="width:45%">
                <input type="button" onclick="chooseCategory('选择分类',2,3,2)" class="btn btn-secondary radius" value="选择分类">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>适用体质:</label>
            <div class="formControls col-xs-8 col-sm-9">
            	<input type="text" class="input-text" id="physique" name="physique" placeholder="请输入适用体质:例:(湿热质)" >
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
	...
	$("#recipes-add").validate({
	    ...
	    submitHandler:function(form){
	        ...
	        $(form).ajaxSubmit({
	            url: "/item/recipes/update/"+parent.getId(),
	            type: "POST",
	            dataType: "json",
