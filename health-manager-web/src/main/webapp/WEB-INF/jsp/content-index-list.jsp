...
<div style="margin-left:200px;">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 内容管理 <span class="c-gray en">&gt;</span> 首页板块内容管理 <span class="c-gray en">&gt;</span><span id="name"></span> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <form id="form-search" class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="content_add('添加展示内容','content-article-add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加展示内容</a></span> <span class="r">最大容纳内容(商品)数：<strong id="limitNum"></strong></span> </div>
        <div class="mt-20">
...
<script type="text/javascript">
        ...
        $('.table').DataTable({
            ...
            "columns": [
                ...
                { "data": "type",
                    render : function(data,type, row, meta) {
                        if(data==0){
                            return "<span class=\"label label-success radius td-status\">关联文章</span>";
                        }else if(data==1){
                            return "<span class=\"label label-warning radius td-status\">其他链接</span>";
                        }else if(data==2){
                            return "<span class=\"label label-primary radius td-status\">关联文章(封面)</span>";
                        }
                    }
                },
                { "data": "picUrl",
                    render: function(data, type, row, meta) {
                        return '<img src="'+data+'" style="width: 80px;height: 60px" alt="" />';
                    }
                },
                { "data": "fullUrl"},
                { "data": "articleId"},
                ...
                },
                {
                    "data": null,
                    render: function (data, type, row, meta) {
                        return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"content_edit('内容编辑','content-banner-edit')\" href=\"javascript:;\" title=\"编辑\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> <a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"content_del(this,"+row.id+")\" href=\"javascript:;\" title=\"删除\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                    }
                }
            ],
            ...
            "aoColumnDefs": [
                {"orderable":false,"aTargets":[0,3,10]}// 制定列不参与排序
            ],
            language: {
    ...
    /*内容-查看*/
    function content_show(title,url,id){
        var index = layer.open({
            type: 2,
            title: title,
            content: url
    ...
    var id=0,articleId=0,articleName="",fullUrl="",type=0,picUrl="";
    ...
    function content_edit(title,url){
        ...
        $('.table tbody').on( 'click', 'tr', function () {
            ...
            articleId = table.row(this).data().articleId;
            articleName = table.row(this).data().articleName;
