...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add" method="post">
   		<input type="text" hidden class="input-text" value="" id="cname" name="cname">
   		<input type="text" hidden class="input-text" value="" id="classid" name="classid">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="dateStr" placeholder="出生日期" onfocus="WdatePicker({ maxDate:'%y-%M-%d' })" class="input-text Wdate">           
			</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>学年:</label>
            <div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="year" placeholder="请填写学年" onfocus="WdatePicker({ dateFmt: 'yyyy',maxDate:'%y' })" class="input-text Wdate" >           
            </div>
        </div>
        <div class="row cl">
