...
<div class="page-container">
    <form name="library-add" action="" method="post" class="form form-horizontal" id="library-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>总量:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入总量" id="sum" name="sum">
           		<input type="text" class="input-text" value="" hidden id="rest" name="rest">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
	...
	$("#library-add").validate({
	    ...
	    submitHandler:function(form){
	    	if(images==null){
                layer.alert('请上传图书展示缩略图! ', {title: '错误信息',icon: 0});
                return;
            }
	    	$("#rest").val($("#sum").val());
	        var index1 = layer.load(3);
	        $(form).ajaxSubmit({
	            url: "/item/library/add",
	            type: "POST",
	            dataType: "json",
